...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-forest-800 text-cream-50 shadow hover:bg-forest-700 active:bg-forest-900",
        secondary:
          "bg-cream-200 text-forest-800 shadow-sm hover:bg-cream-300 active:bg-cream-400",
        outline:
          "border-2 border-forest-800 bg-transparent text-forest-800 hover:bg-forest-800 hover:text-cream-50",
        ghost:
          "text-forest-700 hover:bg-forest-100 hover:text-forest-800",
